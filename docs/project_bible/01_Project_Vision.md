...
|-----------|-------------------|----------|
| **SC-FYP-01: Complete Requirements Specification** | All blueprint docs (01-07) approved; traceability matrix linking requirements → design → tests | Signed-off docs in `docs/project_blueprint/`; traceability matrix document |
